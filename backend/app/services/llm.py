...
class ModelRouterClient:
    ...
    def _catalogue_extraction_system_prompt(self, reference_date: datetime | None = None) -> str:
        ...
        return (
            ...
            "price_per_unit=numeric price/rate only, never Qty/Quantity/Volume/Volum; currency=$/USD=>USD, Rs/INR=>INR, EUR=>EUR, GBP=>GBP; "
            "available_qty=stock/Qty/Quantity/Volume/Volum; unit=kg/g/mg/l/ml/bag/pack/drum/etc; moq=numeric MOQ; "
